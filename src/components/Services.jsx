...
const Services = () => {
  const services = [
    { title: 'B2B Lead Generation', icon: 'Users', span: '2x1', description: 'Targeted prospect lists matching your ideal customer profile with verified contact data.' },
    { title: 'Contact Research', icon: 'Search', span: '1x1', description: 'Decision-maker identification with verified emails and direct dials.' },
    { title: 'Data Enrichment', icon: 'Database', span: '1x1', description: 'Clean, enrich, and update your existing CRM data for accuracy.' },
    { title: 'Email List Building', icon: 'Mail', span: '1x2', description: 'Verified business email lists with bounce rates under 2%. CRM-ready format.' },
    { title: 'LinkedIn Research', icon: 'Building2', span: '1x1', description: 'Deep-dive company and contact research using Sales Navigator.' },
    { title: 'CRM Data Cleaning', icon: 'Sparkles', span: '1x1', description: 'Duplicate removal, formatting, and enrichment for HubSpot & Salesforce.' },
  ]
  ...
  return (
    <section className="section" style={{ borderTop: '1px solid var(--color-rule)' }}>
      <div className="container-page">
        <h2 style={{ color: 'var(--color-ink)', marginBottom: 'var(--space-2xl)' }}>
          Services
        </h2>
...
const ServiceIcon = ({ name }) => {
  const icons = {
    ...
    Building2: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 22V2h12v20"/><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2"/><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/></svg>,
