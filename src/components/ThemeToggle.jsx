...
const ThemeToggle = ({ className = "" }) => {
  ...
  useEffect(() => {
    ...
    if (meta) {
      meta.setAttribute("content", theme === "hum-dark" ? "#1a1815" : "#f9f6ef");
    }
  }, [theme]);
  ...
  return (
    <button
      ...
      title={theme === "hum" ? "Dark mode" : "Light mode"}
      className={`theme-toggle btn btn--soft btn--sm${className ? ` ${className}` : ""}`}
    >
      {theme === "hum-dark" ? (
