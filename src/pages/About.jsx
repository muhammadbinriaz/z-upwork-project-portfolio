        ...
        <div className="container-page">
          ...
          >
            ...
            <div>
              ...
              >
                I'm <strong style={{ color: 'var(--color-ink)', fontWeight: 500 }}>Muhammad Zaryab</strong>,
              ...
              >
                <div>
                  <div className="stat-figure" style={{ fontSize: 'var(--text-4xl)' }}>
                    128
                  </div>
                  <p className="stat-qualifier" style={{ fontSize: 'var(--text-sm)' }}>
                    Projects
                  </p>
                </div>
                <div>
            ...
            >
              ...
              <p style={{ color: 'var(--color-accent)', fontSize: 'var(--text-sm)', fontWeight: 500 }}>
                Top Rated Plus Specialist
              </p>

              <div style={{ width: '100%', borderTop: '1px solid var(--color-rule)', paddingTop: 'var(--space-md)' }}>
                <h3 style={{ fontSize: 'var(--text-sm)', color: 'var(--color-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 'var(--space-sm)' }}>
                  Education
                </h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-sm)', textAlign: 'left' }}>
                  <div>
                    <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-ink)', fontWeight: 500 }}>
              ...
              <div style={{ width: '100%', borderTop: '1px solid var(--color-rule)', paddingTop: 'var(--space-md)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xs)', textAlign: 'left' }}>
